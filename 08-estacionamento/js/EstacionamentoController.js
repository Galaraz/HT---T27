class EstacionamentoController {
    ...
    calcularResultado() {
        ...
        document.getElementById('maisNovo').innerHTML = "<b>Nome</b>: " + maisNovo.nome + " - <b>Marca</b>: " + maisNovo.marca+ " <b>Ano</b>: " + maisNovo.ano;
        document.getElementById('maisVelho').innerText = JSON.stringify(maisVelho).replace(/"|{|}|/g , ""  )
